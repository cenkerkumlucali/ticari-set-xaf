...
using TicariSet.Module.BusinessObjects.Banka;
...
namespace TicariSet.Module.BusinessObjects.Cari
{
    ...
    [RuleIsReferenced("RIR-Cariler.Fisler", DefaultContexts.Delete, typeof(Fisler.Fisler), "CariID", InvertResult = true, CriteriaEvaluationBehavior = CriteriaEvaluationBehavior.BeforeTransaction, MessageTemplateMustBeReferenced = "{TargetObject} nesne referans alınmamalıdır.")]
    ...
    public class Cariler : BaseObject
    {
        ...
        public XPCollection<Fisler.Fisler> AlisSatisIslem => GetCollection<Fisler.Fisler>(nameof(AlisSatisIslem));
